...
public class PerguntaActivity extends AppCompatActivity {
    ...
    public void responder (View view){
        ...
        boolean acertou;
            ...
            if (idRadioButtonClicado == intent.getIntExtra("correta",R.id.rbB)) {
                ...
                acertou = true;
                    ...
                    //criamos uma nova intent para retornamos um valor a tela principal
                    Intent novaIntent = new Intent();

                    //colocamos um paramentro na novaIntent para ela entregar o msm a tela para a qual retornaremos
                    novaIntent.putExtra("acertou", acertou);

                    //Por fim, indicamos que a tela fechada devolvendo a novaIntent
